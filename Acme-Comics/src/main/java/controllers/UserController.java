...
public class UserController extends AbstractController {
    ...
    public ModelAndView edit()
    {
        ...
        ModelAndView result = createEditModelAndView("actors/edit", "users/update.do", null, null, (User) getPrincipal());
        return result;
    }

    @RequestMapping(value = "/update", method = RequestMethod.POST)
    public ModelAndView update(@ModelAttribute("user") User user, BindingResult binding, RedirectAttributes redir)
    {
        CheckUtils.checkPrincipalAuthority(Authority.USER);

        String globalErrorMessage = null;

        user = userService.bindForUpdate(user, binding);
        if (!binding.hasErrors()) {
            try {
        ...
        return createEditModelAndView("actors/edit", "users/update.do", globalErrorMessage, binding, user);
    }

    public ModelAndView createEditModelAndView(String viewName, String formAction, String globalErrorMessage, BindingResult binding, User actor)
    {
        ModelAndView result = ControllerUtils.createViewWithBinding(
