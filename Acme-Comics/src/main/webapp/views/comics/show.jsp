...
<div>
	<display:table pagesize="${displayTagPageSize}" name="comic.comicComicCharacters" id="comicComicCharacter" requestURI="${currentRequestUri}" sort="list">
        <display:column property="comicCharacter.alias" titleKey="comic_comic_characters.comicCharacter" sortable="true"  href="comic_characters/show.do" paramProperty="comicCharacter.id" paramId="id" escapeXml="true" />
        <display:column property="role" titleKey="comic_comic_characters.role" escapeXml="true" />
...
<div>
	<display:table pagesize="${displayTagPageSize}" name="volumes" id="volume" requestURI="${currentRequestUri}" sort="list">
	    ...
	    <display:column property="author.name" titleKey="volume.author" href="authors/show.do" paramId="id" paramProperty="author.id" sortable="true" escapeXml="true" />
	    <display:column property="releaseDate" titleKey="volume.releaseDate" format="{0,date,dd/MM/yyyy}" sortable="true" />
	    <c:if test="${principal != null and principal.administrator or principal.trusted}">
	        <display:column property="orderNumber" titleKey="volume.orderNumber" sortable="true" escapeXml="true" />
	    </c:if>
